...
Route::get('/admin/teacher/{id}/edit', 'Admin\TeacherController@edit')->name('admin_teacher_edit');
Route::put('/admin/teacher/{id}', 'Admin\TeacherController@update')->name('admin_teacher_update');
Route::delete('/admin/teacher/{id}', 'Admin\TeacherController@destroy')->name('admin_teacher_delete');
